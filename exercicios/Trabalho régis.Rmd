...
# A partir de agora, iremos iniciar a implementação e previsão do modelo.

# Assim, iremos carregar e instalar alguns pacotes, utilizar o script anterior da análise preliminar como fonte  e implementar o modelo de previsão.
...
# Aqui, criamos a variável cobertura que iremos utilizar na equação para o modelo de previsão.
...
...
# Para melhorar e eficiência computacional o método da função cross validation foi alterado para "cv" e "boot632", é possível que isso gere overfitting no modelo
